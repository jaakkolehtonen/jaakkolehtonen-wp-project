...
class MiddleModel extends \DustPress\Model {
    ...
    /**
     * A wrapper function for querying single events.
     *
     * @return array|bool|WP_Query
     */
    protected function get_single_event() {
        $args = [
            'post_type' => 'event',
        ];

        // Use the Query class to get extended data for single events.
    ...
    /**
     * A wrapper function for querying upcoming & ongoing events.
     *
     * @param int $page     The page we are on.
     ...
     * @return array|bool|WP_Query
     */
    protected function get_upcoming_events( $page = 0, $per_page = 4 ) {
        ...
        // Use the Query class to get extended data for all events.
     ...
     * @return array|bool|WP_Query
     */
    protected function get_all_events( $page = 0, $per_page = 4 ) {
